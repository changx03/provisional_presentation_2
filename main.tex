...
\begin{examples}
    \begin{figure}
        ...
        \caption{\textbf{Feature Squeezing} trains multiple models with squeezed training data, such as colours depth re-scaling, Gaussian blur filter and median filter\footcite{xu2017feature}}
    \end{figure}
\end{examples}
